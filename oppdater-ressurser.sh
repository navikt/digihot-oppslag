...
curl https://ws.geonorge.no/kommuneinfo/v1/fylkerkommuner?sorterkommuner=kommunenummer&sorterfylker=fylkesnummer | jq -r '.[].kommuner[] | .fylkesnummer + ";" + .fylkesnavn + ";" + .kommunenummer + ";" + .kommunenavnNorsk' >src/main/resources/geografi/kommuner.csv
